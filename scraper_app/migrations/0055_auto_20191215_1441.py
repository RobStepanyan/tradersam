    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issuer', models.CharField(choices=[('ALPS', 'ALPS'), ('FlexShares', 'FlexShares'), ('Lattice', 'Lattice'), ('Deutsche Bank', 'Deutsche Bank'), ('Strategy shares', 'Strategy shares'), ('Credit Suisse', 'Credit Suisse'), ('ProShares', 'ProShares'), ('Sprott', 'Sprott'), ('DoubleLine', 'DoubleLine'), ('VelocityShares', 'VelocityShares'), ('Teucrium', 'Teucrium'), ('PowerShares', 'PowerShares'), ('ArrowShares', 'ArrowShares'), ('ETF Series Solutions', 'ETF Series Solutions'), ('Neuberger Berman', 'Neuberger Berman'), ('Horizons', 'Horizons'), ('BlackRock', 'BlackRock'), ('AdvisorShares', 'AdvisorShares'), ('JPMorgan', 'JPMorgan'), ('Pure Funds', 'Pure Funds'), ('ELEMENTS', 'ELEMENTS'), ('Pimco', 'Pimco'), ('Fidelity', 'Fidelity'), ('SPDR', 'SPDR'), ('Columbia', 'Columbia'), ('KraneShares', 'KraneShares'), ('QuantShares', 'QuantShares'), ('Pacer', 'Pacer'), ('Van Eck', 'Van Eck'), ('Global X', 'Global X'), ('Vanguard', 'Vanguard'), ('UBS', 'UBS'), ('Innovator Capital Management LLC', 'Innovator Capital Management LLC'), ('Other', 'Other'), ('Cambria', 'Cambria'), ('ETFS', 'ETFS'), ('Schwab', 'Schwab'), ('NexPoint Advisors, LP', 'NexPoint Advisors, LP'), ('ARK', 'ARK'), ('IQ', 'IQ'), ('Deutsche X-trackers', 'Deutsche X-trackers'), ('USCF', 'USCF'), ('Franklin Templeton', 'Franklin Templeton'), ('Citigroup', 'Citigroup'), ('First Trust', 'First Trust'), ('Goldman Sachs', 'Goldman Sachs'), ('Guggenheim', 'Guggenheim'), ('WisdomTree', 'WisdomTree'), ('Barclays Funds', 'Barclays Funds'), ('CSOP', 'CSOP'), ('Morgan Stanley', 'Morgan Stanley'), ('iShares', 'iShares'), ('Renaissance', 'Renaissance'), ('Direxion', 'Direxion'), ('Oppenheimer', 'Oppenheimer')], max_length=32)),
